...
@NamedQueries({
	@NamedQuery(name = "Clientetarjeta.findByIdPro", query = "SELECT d FROM Clientetarjeta d WHERE d.id.idcliente = :idCliente"),
	@NamedQuery(name = "Clientetarjeta.findByNombre", query = "SELECT d FROM Clientetarjeta d WHERE d.fechaEmision = :Fecha_Emision"),
	@NamedQuery(name = "Clientetarjeta.findByID", query = "SELECT ct FROM Clientetarjeta ct Where ct.id.idcliente=:id_cliente AND ct.id.idtarjetacredito=:id_tarjeta")
})
