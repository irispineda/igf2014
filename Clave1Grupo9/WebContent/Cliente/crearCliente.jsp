...
<%
	...
	cliente.setNombClient(request
			.getParameter("nombClient"));
	cliente.setApellidoClient(request
			.getParameter("apellidoClient"));
	cliente.setDireccion(request
			.getParameter("direccion"));
	cliente.setTelefono(request
			.getParameter("telefono"));
	cliente.setFechaNacimiento(formatter.parse(request.getParameter("fechaNacimiento")));
	cliente.setEmail(request
			.getParameter("email"));
