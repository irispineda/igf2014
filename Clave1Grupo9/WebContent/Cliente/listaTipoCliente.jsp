...
<%
	...
	TipoClienteCtrl tcControl = new TipoClienteCtrl();
	List<Tipocliente> listaTipoCliente = tcControl.findByAll();

	String lista = "";
	for (Tipocliente tc : listaTipoCliente) {
		lista = lista + "<tr>"
	                  + "<td>" + tc.getIdtipocliente() + "</td>"
